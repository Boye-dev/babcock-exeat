...
app.use("/api", require("./controllers/exeat"));
app.use("/api", require("./controllers/home"));

// Serve static assets if in production
if (process.env.NODE_ENV === "production") {
  //Set static folder
  app.use(express.static(path.join(__dirname, "babcock-exeat", "build")));
  app.get("*", (req, res) => {
    res.sendFile(path.join(__dirname, "babcock-exeat", "build", "index.html"));
  });
}
